...
const COMMANDS: QuickCommand[] = [
  ...
  { key: "strength_increase_load", label: "Increase difficulty", focus: "strength", scopes: ["exercise", "session", "week", "phase", "block", "system"], tags: ["strength", "intensity", "load", "force", "squat", "deadlift", "bench", "lower", "upper"], safety: "increase_load" },
