    ...
    <div className="w-60 flex-shrink-0 bg-sidebar border-r border-sidebar-border flex flex-col h-full">
      ...
      <div className="px-2 pb-3 pt-1 border-t border-sidebar-border">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-muted-foreground hover:bg-sidebar-accent hover:text-foreground transition-all duration-150 text-sm"
        >
