...
export const EXERCISE_LIBRARY: ExerciseEntry[] = [
  ...
  // ── ECCENTRIC / ISOMETRIC HAMSTRING ──
  { name: "Slider Hamstring Curl", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "hypertrophy", "general_fitness"], notes: "Lie on back, feet on sliders — bridge up and curl both heels in simultaneously. Eccentric dominant: push heels out slowly against full resistance. The primary progression step before the Nordic curl — lower absolute load, easier to control the eccentric." },
  { name: "Single-Leg Slider Curl", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "hypertrophy"], notes: "One leg curls while the other floats — demands full unilateral hamstring eccentric control. Direct precursor to the Nordic. Slow the lowering phase to 3–5 seconds." },
  { name: "Swiss Ball Hamstring Curl", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "beginner", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["general_fitness", "hypertrophy", "athletic_performance"], notes: "Bridge up with heels on the ball, curl the ball in. Combines hip extension with knee flexion — trains the hamstring in its dual role. Eccentric emphasis on the extension back out." },
  { name: "Single-Leg Swiss Ball Curl", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "hypertrophy"], notes: "Same as Swiss ball curl but one leg only — the free leg floats. Full hip extension must be maintained throughout. Significant eccentric and stability demand." },
  { name: "GHD Hamstring Curl", pattern: "iso_legs", equipment: ["machine"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "hypertrophy", "strength"], notes: "Glute-ham device knee-flexion curl — the machine version of the Nordic. Hip stays extended throughout, isolating the knee-flexion eccentric function of the hamstring. Slower eccentric than the Nordic but allows loaded progressions." },
  { name: "Razor Curl (Kneeling Hamstring Curl)", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance"], notes: "Kneeling, ankles anchored — fall forward slowly under eccentric hamstring control, using hands to catch and push back up. A lower-torque Nordic alternative that builds toward unassisted Nordics. Excellent re-entry hamstring loading option." },
  { name: "Leg Curl with Eccentric Emphasis", pattern: "iso_legs", equipment: ["machine"], difficulty: "beginner", jointStress: ["knee_dominant"], goalBias: ["hypertrophy", "athletic_performance", "general_fitness"], notes: "Curl up with both legs, lower on one leg with a 3–5 second controlled eccentric. The most accessible eccentric hamstring overload — can be done on any leg curl machine without Nordic capability." },
  { name: "Isometric Hamstring Hold", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "beginner", jointStress: ["knee_dominant"], goalBias: ["athletic_performance", "general_fitness", "strength"], notes: "Seated or lying, press heel firmly into floor or a fixed surface and hold — maximum contraction without movement. Pure isometric hamstring bracing. Used in reactive neuromuscular training (RNT) and early-stage hamstring rehab where eccentric loading is not yet appropriate." },
  { name: "90-90 Hamstring Isometric", pattern: "iso_legs", equipment: ["bodyweight"], difficulty: "beginner", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "general_fitness"], notes: "Seated with hip and knee at 90°, press heel into the floor and hold for 20–45 seconds. Isometric in the mid-range of hamstring function. Builds motor unit activation before eccentric loading is tolerated. Effective re-entry and activation protocol." },
  { name: "Isometric RDL Hold", pattern: "hinge", equipment: ["barbell", "dumbbell", "bodyweight"], difficulty: "intermediate", jointStress: ["hip_stress", "low_back_stress"], goalBias: ["athletic_performance", "strength"], notes: "Perform a Romanian deadlift, pause at the bottom — maximal hamstring stretch position — and hold for 3–5 seconds per rep. Combines hip-dominant eccentric loading with a stretch isometric. Builds the hip extension strength and hamstring tendon tolerance that transfers directly to sprinting mechanics." },

  // ── POSTERIOR CHAIN — ACCESSORY ──
  { name: "Glute Ham Raise", pattern: "hinge", equipment: ["machine"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "strength"], notes: "GHD — hip extension plus knee flexion in one movement. The hamstring must work both functions simultaneously. Extreme posterior chain demand. Most demanding bodyweight hamstring exercise. Progress from partial ROM before attempting full." },
  { name: "Reverse Hyperextension", pattern: "hinge", equipment: ["machine"], difficulty: "beginner", jointStress: ["hip_stress", "low_back_stress"], goalBias: ["athletic_performance", "general_fitness", "strength"], notes: "Pendulum swings from a reverse hyper machine — decompresses the spine while loading hip extension eccentrically on the lowering phase. Exceptional low-back and glute accessory with minimal compressive stress. A staple Louie Simmons posterior chain tool." },
  { name: "Back Extension (45° Hyperextension)", pattern: "hinge", equipment: ["machine", "bodyweight"], difficulty: "beginner", jointStress: ["low_back_stress", "hip_stress"], goalBias: ["general_fitness", "strength", "athletic_performance"], notes: "On a 45° bench — hinge at the hip, extend back to neutral. Foundational posterior chain accessory. Load with a plate or dumbbell across the chest to progress. Builds erector and glute capacity without the spinal load of a deadlift variation." },

  // ── ECCENTRIC CALF ──
  { name: "Eccentric Single-Leg Calf Raise", pattern: "iso_legs", equipment: ["bodyweight", "dumbbell"], difficulty: "beginner", jointStress: ["knee_dominant"], goalBias: ["athletic_performance", "general_fitness", "hypertrophy"], notes: "Rise on two legs, lower on one over 3–5 seconds. The Alfredson Protocol eccentric — the gold-standard Achilles tendon loading method. Full range of motion including a stretch at the bottom. Both straight-knee (gastrocnemius) and bent-knee (soleus) versions must be used. 3 × 15 twice daily is the clinical protocol." },

  // ── ECCENTRIC UPPER BODY ──
  { name: "Slow Negative Pull-Up", pattern: "pull_vertical", equipment: ["bodyweight"], difficulty: "intermediate", jointStress: ["shoulder_dominant", "elbow_stress"], goalBias: ["strength", "hypertrophy", "athletic_performance"], notes: "Jump or step to the top position — lower over 5–8 seconds under complete control. Eccentric-only pull-up. Builds the lat and bicep strength needed for unassisted pull-ups, and produces greater hypertrophy stimulus than standard pull-ups at moderate volume." },
  { name: "Eccentric Ring Row", pattern: "pull_horizontal", equipment: ["bodyweight"], difficulty: "intermediate", jointStress: [], goalBias: ["strength", "hypertrophy", "athletic_performance"], notes: "Pull up with two arms, lower on one arm over 3–5 seconds — or lower bilaterally with a 5-second eccentric from an elevated foot angle. Eccentric horizontal pulling. Builds rear delt, rhomboid, and mid-back eccentric capacity. Excellent shoulder health and posture work." },
  ...
  { name: "Reverse Lunge", pattern: "squat", equipment: ["dumbbell", "barbell", "bodyweight"], difficulty: "beginner", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["hypertrophy", "athletic_performance", "general_fitness"], notes: "Step back — keep the front shin vertical. More hip-dominant than a forward lunge. Easier on the knee for most athletes." },
  { name: "Reverse Lunge from Deficit", pattern: "squat", equipment: ["dumbbell", "barbell", "bodyweight"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["hypertrophy", "athletic_performance", "strength"], notes: "Front foot elevated on a plate — increases hip flexor and quad ROM. Use when standard reverse lunge feels too easy." },
  { name: "Single-Leg Hip Thrust", pattern: "hinge", equipment: ["barbell", "dumbbell", "bodyweight"], difficulty: "intermediate", jointStress: ["hip_stress"], goalBias: ["hypertrophy", "athletic_performance"], notes: "One foot planted, one leg extended — demands full unilateral glute activation. Expose asymmetries the bilateral version hides." },
  { name: "Single-Leg Glute Bridge", pattern: "hinge", equipment: ["bodyweight", "dumbbell", "barbell"], difficulty: "beginner", jointStress: ["hip_stress"], goalBias: ["general_fitness", "athletic_performance", "hypertrophy"], notes: "Bilateral bridge progression — one leg drives, one floats. Corrects glute imbalances and builds re-entry-safe hip extension." },
  { name: "Pistol Squat", pattern: "squat", equipment: ["bodyweight", "dumbbell", "kettlebell"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "strength"], notes: "Full single-leg squat to depth — demands hip mobility, ankle dorsiflexion, and quad strength simultaneously. Use a counterweight for beginners." },
  { name: "Assisted Pistol Squat", pattern: "squat", equipment: ["bodyweight", "band"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance", "general_fitness"], notes: "Band or TRX assists the bottom position. Trains the full pistol pattern before loading removes the assistance. Step before unassisted." },
  { name: "Single-Leg Box Jump", pattern: "power_explosive", equipment: ["bodyweight"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance"], notes: "Take off and land on one leg — unilateral explosive demand that mirrors sprinting and cutting mechanics. Land softly with full hip and knee absorption." },
  { name: "Single-Leg Broad Jump", pattern: "power_explosive", equipment: ["bodyweight"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance"], notes: "Horizontal single-leg power — the most sport-specific unilateral power test. Drive arm and free leg aggressively. Stick the landing before resetting." },
  { name: "Single-Leg Lateral Bound (Stick)", pattern: "power_explosive", equipment: ["bodyweight"], difficulty: "intermediate", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance"], notes: "Push off one leg laterally, land on the same leg — hold the landing for 1–2 sec. Teaches deceleration and single-leg stability under lateral momentum." },
  { name: "Triple Bound", pattern: "power_explosive", equipment: ["bodyweight"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance"], notes: "Three consecutive single-leg hops for maximum total distance — full triple extension each rep. Classic combine and track test. Tests both unilateral power output and repeated single-leg landing ability. Both legs tested separately." },
  { name: "Triple Broad Jump", pattern: "power_explosive", equipment: ["bodyweight"], difficulty: "advanced", jointStress: ["knee_dominant", "hip_stress"], goalBias: ["athletic_performance"], notes: "Three consecutive bilateral broad jumps for max total distance — stick the third landing. An accumulated horizontal power test that loads the landing repeatedly. Measure from take-off to final landing heel. More sprint-specific than a single broad jump." },

  // ── SINGLE-ARM / UNILATERAL UPPER BODY ──
  { name: "Single-Arm Dumbbell Bench Press", pattern: "push_horizontal", equipment: ["dumbbell"], difficulty: "intermediate", jointStress: ["shoulder_dominant"], goalBias: ["hypertrophy", "athletic_performance", "strength"], notes: "Non-pressing side creates anti-rotation demand on the core. Exposes shoulder asymmetries. Alternate arms each set or press one side fully." },
  { name: "Single-Arm Landmine Press", pattern: "push_vertical", equipment: ["barbell"], difficulty: "intermediate", jointStress: ["shoulder_dominant"], goalBias: ["athletic_performance", "strength", "general_fitness"], notes: "Half-kneeling or standing — shoulder-friendly arc of motion with trunk anti-rotation demand. Superior to bilateral landmine for athletic pressing." },
  { name: "Single-Arm Dumbbell Overhead Press", pattern: "push_vertical", equipment: ["dumbbell"], difficulty: "intermediate", jointStress: ["shoulder_dominant"], goalBias: ["hypertrophy", "athletic_performance", "strength"], notes: "Seated or standing — the non-pressing side forces anti-lateral flexion through the trunk. Identifies shoulder strength imbalances immediately." },
  { name: "Single-Arm Cable Row", pattern: "pull_horizontal", equipment: ["cable"], difficulty: "beginner", jointStress: [], goalBias: ["hypertrophy", "athletic_performance", "general_fitness"], notes: "Full retraction and slight rotation at end range — allows greater ROM than bilateral rows. Corrects pulling asymmetries and trains rotational control." },
  { name: "Single-Arm Dumbbell Row (Tripod)", pattern: "pull_horizontal", equipment: ["dumbbell"], difficulty: "beginner", jointStress: [], goalBias: ["hypertrophy", "general_fitness", "strength"], notes: "Three points of contact — opposite hand and knee on bench. Drive the elbow up and back, allow a slight thoracic rotation at top for full lat contraction." },
  { name: "Single-Arm Lat Pulldown", pattern: "pull_vertical", equipment: ["cable"], difficulty: "intermediate", jointStress: ["shoulder_dominant"], goalBias: ["hypertrophy", "athletic_performance"], notes: "Slight lateral lean — allows full unilateral lat stretch and contraction. Useful for athletes with notable bilateral pulling asymmetry." },
  { name: "Single-Arm Cable Chest Fly", pattern: "iso_chest", equipment: ["cable"], difficulty: "beginner", jointStress: ["shoulder_dominant"], goalBias: ["hypertrophy"], notes: "Complete full range on each side independently — the bilateral version always has a dominant side compensating. This removes the compensation." },
  { name: "Single-Arm Farmer Carry", pattern: "carry", equipment: ["dumbbell", "kettlebell"], difficulty: "beginner", jointStress: ["spine_load"], goalBias: ["general_fitness", "athletic_performance", "strength"], notes: "One-sided load demands total lateral anti-flexion through the trunk. A direct core and grip strength builder that transfers to every carrying and bracing task." },
