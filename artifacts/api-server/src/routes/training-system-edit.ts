...
const STRUCTURED_INTENT_TRANSFORMATION: Record<string, string> = {
  ...
  strength_lower_impact:     "lower_impact",
  strength_home_gym:         "home_gym",
  ...
  speed_lower_impact:        "lower_impact",
  speed_limited_space:       "limited_space",
  mobility_more_hip_focus:    "recovery",
  mobility_more_recovery_flow:"recovery",
  mobility_end_range_control: "strength",
  mobility_thoracic_spine:    "recovery",
  mobility_shorten_sessions:  "reduce_time",
  mobility_lower_intensity:   "lower_impact",
  mobility_desk_reset:        "desk_reset",
};
