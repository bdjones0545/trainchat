...
/**
 * Set headers that are merged into every request made by customFetch.
 * Useful for attaching device IDs or other ambient context to all calls.
 *
 * The provided headers are merged into the existing defaults — call with an
 * empty object to clear specific keys by reassignment.
 */
